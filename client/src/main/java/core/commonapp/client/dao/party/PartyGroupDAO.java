...
public interface PartyGroupDAO
{
    ...
    /**
     * Find PartyGroup by partyId, allow for lazy loading relationships
     * 
     * @param partyGroupId
     * @param includeContactMechs
     * @param includeFromRelationships
     * @param includeToRelationships
     * @return
     */
    ...
    /**
     * Save PartyGroup object
     * 
     * @param partGroup
     * @return
     */
    public PartyGroup save(PartyGroup partGroup);
