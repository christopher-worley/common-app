...
public interface StatusTransitionRoleDAO
{
    ...
    /**
     * save status transition role
     * 
     * @param statusTransitionRole
     * @return
     */
