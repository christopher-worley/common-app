 ...
 *
 */
package core.commonapp.client.dao.product;
...
{
    /**
     * find all <code>ProductType</code> objects
     * @return
     */
    public List<ProductTypeHibernateImpl> findAll();

    /**
     * find <code>ProductType</code> by id
     * 
     * @param id
     * @return
     */
    ...
    /**
     * save <code>ProductType</code>
     * 
     * @param ProductTypeHibernateImpl
     * @return
     */
