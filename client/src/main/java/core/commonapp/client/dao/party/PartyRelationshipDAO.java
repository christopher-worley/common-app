...
{
    /**
     * find <code>PartyRelationship</code> by id
     * 
     * @param id
     * @return
     */
    ...
    /**
     * save <code>PartyRelationship</code>
     * 
     * @param PartyRelationshipHibernateImpl
     * @return
     */
    public PartyRelationship save(PartyRelationship party);
