...
@Repository
public class TaskRelationshipDaoHibernateImpl extends BaseDaoJpaImpl<TaskRelationship> implements TaskRelationshipDao
{
	...
	@Override
	public Class<TaskRelationship> getPersistClass() {
