...
public class UserLoginSecurityGroupHibernateImpl extends LightEntity implements DataObject, Serializable, Expirable, UserLoginSecurityGroup
{
    ...
    @ManyToOne (targetEntity=SecurityGroupHibernateImpl.class)
