...
public class AgreementTypeHibernateImpl extends LightEntity implements Keyable, AgreementType
{
    @Id
    ...
    {
        AgreementTypeHibernateImpl agreementType = (AgreementTypeHibernateImpl) object;
