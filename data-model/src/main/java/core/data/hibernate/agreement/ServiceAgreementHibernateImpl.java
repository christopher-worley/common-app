...
public class ServiceAgreementHibernateImpl extends AgreementHibernateImpl implements ServiceAgreement
{
    @ManyToOne (targetEntity=ProductHibernateImpl.class)
    @JoinColumn (name="product_id")
    private Product product;
    
    @ManyToOne (targetEntity=ServiceIntervalHibernateImpl.class)
