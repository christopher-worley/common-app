...
public class SurveyItemAssociationHibernateImpl extends LightEntity implements SurveyItemAssociation
{
    ...
    @ManyToOne (targetEntity=SurveyAssociationTypeHibernateImpl.class)
    @JoinColumn (name="survey_association_type_id")
    private SurveyAssociationType surveyAssociationType;

    @ManyToOne (targetEntity=SurveyItemHibernateImpl.class)
    ...
    /* (non-Javadoc)
     * @see core.data.model.survey.SurveyItemAssociation#setSurveyAssociationType(core.data.model.survey.SurveyAssociationTypeHibernateImpl)
     */
