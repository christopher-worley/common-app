...
{
    /** keys */
    public static String KEY_EMAIL_ADDRESS = "_EMAIL_ADDRESS";
    public static String KEY_PHONE_NUMBER = "_PHONE_NUMBER";
    public static String KEY_POSTAL_ADDRESS = "_POSTAL_ADDRESS";
}
