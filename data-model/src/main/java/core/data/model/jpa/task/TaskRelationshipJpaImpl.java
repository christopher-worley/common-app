...
public class TaskRelationshipJpaImpl implements TaskRelationship
{
    ...
    @ManyToOne (targetEntity=TaskJpaImpl.class)
    ...
    @ManyToOne (targetEntity=TaskRelationshipTypeJpaImpl.class)
