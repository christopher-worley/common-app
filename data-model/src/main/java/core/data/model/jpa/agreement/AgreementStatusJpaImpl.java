...
import core.data.model.jpa.status.StatusJpaImpl;
import core.data.model.status.Status;
import core.data.model.util.DataUtil;

@Entity
@Table (name="agreement_status")
public class AgreementStatusJpaImpl implements AgreementStatus
{
    @Id
    ...
    @ManyToOne (targetEntity=AgreementJpaImpl.class)
    @JoinColumn (name="agreement_id")
    private Agreement agreement;

    @ManyToOne (targetEntity=StatusJpaImpl.class)
