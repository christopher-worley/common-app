...
public class SurveyItemTypeCacheHandler extends AbstractCacheHandler implements KeyedCacheHandler
{

    @Override
    public Class getDataClass()
    {
        return SurveyItemType.class;
    }
    ...
    public List getObjects()
    {
        ...
        ServiceResult result = productService.findAllSurveyItemTypes();
        if (result.isSuccess())
        {
