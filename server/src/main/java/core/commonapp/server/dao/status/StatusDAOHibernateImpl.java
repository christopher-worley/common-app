...
public class StatusDAOHibernateImpl extends HibernateDaoSupport implements StatusDAO
{
     ...
     */
    @Autowired
    public StatusDAOHibernateImpl(GenericDAO genericDAO)
    {
        super();
    ...
    {
        return genericDAO.findAll(StatusHibernateImpl.class);
    }

    @Override
    public Status findById(Integer id)
    {
        return (Status) genericDAO.findById(StatusHibernateImpl.class, id);
    }


    @Override
    public Status save(StatusHibernateImpl status)
    {
