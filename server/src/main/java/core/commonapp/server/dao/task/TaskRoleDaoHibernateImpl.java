...
public class TaskRoleDaoHibernateImpl extends BaseDaoJpaImpl<TaskRole> implements TaskRoleDao
{
	...
	@Override
	public Class<TaskRole> getPersistClass() {
		return TaskRole.class;
	}
