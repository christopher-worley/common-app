...
public class ContactMechPurposeDaoHibernateImpl extends BaseDaoJpaImpl<ContactMechPurpose> implements ContactMechPurposeDao
{
	...
	@Override
	public Class<ContactMechPurpose> getPersistClass() {
