...
public class StatusTransitionDaoHibernateImpl extends BaseDaoJpaImpl<StatusTransition> implements StatusTransitionDao
{
	...
	@Override
	public Class<StatusTransition> getPersistClass() {
		return StatusTransition.class;
	}
