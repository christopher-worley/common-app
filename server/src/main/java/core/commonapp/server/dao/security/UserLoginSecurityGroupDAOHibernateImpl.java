...
public class UserLoginSecurityGroupDAOHibernateImpl extends HibernateDaoSupport implements UserLoginSecurityGroupDAO
{

    @Override
    public List<UserLoginSecurityGroup> findBySecurityGroup(SecurityGroup securityGroup, boolean includeOld)
    {
        DetachedCriteria criteria = DetachedCriteria.forClass(UserLoginSecurityGroupHibernateImpl.class);
        ...
        return (List<UserLoginSecurityGroup>) getHibernateTemplate().findByCriteria(criteria);
    }
